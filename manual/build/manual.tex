...
\posttitle{%
  \\
  \vspace{2cm}
  \includegraphics[width=11cm]{schema.pdf}
  \end{center}
}
...
Electronic components are sensitive to static electricity. Before handling the PCB, ground yourself by touching a grounded metal object or use an anti-static wrist strap.
...
\begin{enumerate}
  \item Mount the four female 2\texttimes5 connectors on the pins of the Daisy Patch Submodule. See figure \ref{daisy}. This will make it easier to align all the connectors properly.
...
\begin{enumerate}
  \item Take the male 2\texttimes5 connector and put the side with shorter legs through the footprint marked as ``Power''. Make sure to put it on the correct side of the PCB.
...
\begin{enumerate}
  ...
  \item Place all potentiometers in the PCB. If the big legs are hard to snap in, flatten them with pliers first. Do not solder the legs yet.
