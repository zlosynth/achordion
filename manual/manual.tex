...
% The front panel of the module is made out of aluminium with engraved lettering, it is available in black or light anodized finishes.
...
% The boxed power connector should make it easier to connect with the correct polarity.
...
% If you are unsure on what to dial in, keep the default root note and experiment with the modes.
...
% You may wonder how to select minor or major chords. Thanks to quantization, the quality of each chord is selected automatically, based on the root note, in order to stay in tune.
