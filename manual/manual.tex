...
On the left side, there is a column of LEDs (X) that are visualizing the currently selected parameter. Below the LEDs, there is a button (Y) providing access to alternative parameters of each of the knobs.
