...
By default TONE and TONE' input CV snaps to the closest note. An alternative firmware can be installed to map white keyboard keys to the notes of any scale.
...
\begin{tabular}{@{}rl@{}}
  ...
  v2.4 & White key quantization was disabled \\
\end{tabular}
